...
public class CheckoutListAdapter extends RecyclerView.Adapter implements Filterable {
    ...
    public CheckoutListAdapter(Context context, List<Size> list) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder.getItemViewType() == VIEW_TYPE_ITEM) {
            if (holder instanceof MyViewHolder) {
                ...
                mainHolder.binding.tvWeight.setText(model.getQuantity() + " " + (model.getCartMType().equals("0") ? "Kg" : "Pcs"));
                ...
                mainHolder.binding.tvPiece.setText(model.getPiece() + " " + (model.getCartMType().equals("0") ? "Piece" : "Kg"));
            }
        }
    }
    ...
    public interface CartClickListener {
        void onItemSelected(int position, Size model, String quantity, String piece, int status);
    }
}