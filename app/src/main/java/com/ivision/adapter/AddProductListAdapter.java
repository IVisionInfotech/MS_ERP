...
public class AddProductListAdapter extends RecyclerView.Adapter implements Filterable {
    ...
    public AddProductListAdapter(Context context, List<Product> list, ClickListener listener) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder.getItemViewType() == VIEW_TYPE_ITEM) {
            if (holder instanceof MyViewHolder) {
                ...
                mainHolder.binding.ivImage.setVisibility(View.VISIBLE);
                mainHolder.binding.tvTitle.setText(model.getName());
                mainHolder.binding.etPrice.setVisibility(View.GONE);

                mainHolder.binding.btnSubmit.setText("Add");
