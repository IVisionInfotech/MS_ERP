...
public class SelectCustomerListAdapter extends RecyclerView.Adapter implements Filterable {
    ...
    public SelectCustomerListAdapter(Context context, List<Customer> list, String customerId, ClickListener listener) {
