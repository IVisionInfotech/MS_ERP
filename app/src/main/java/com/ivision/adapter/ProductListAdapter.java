...
import com.ivision.databinding.RecyclerviewProductListItemBinding;
...
public class ProductListAdapter extends RecyclerView.Adapter implements Filterable {
    ...
    public ProductListAdapter(Context context, List<Product> list, ClickListener listener) {
    ...
    public ProductListAdapter(Context context, List<Product> list, ClickListener listener, CartClickListener cartClickListener) {
        this.context = context;
        this.session = new Session(context);
        this.list = list;
        this.filterList = list;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_TYPE_ITEM) {
            listHolder = new MyViewHolder(RecyclerviewProductListItemBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false));
...
//                mainHolder.binding.tvPrice.setText(context.getResources().getString(R.string.rupee) + " " + model.getBasicPrice());
            }
        }
    }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private RecyclerviewProductListItemBinding binding;
        private ProgressbarBinding progressbarBinding;

        MyViewHolder(RecyclerviewProductListItemBinding binding) {
