...
import com.ivision.databinding.RecyclerviewMillPriceListItemBinding;
...
public class MillPriceListAdapter extends RecyclerView.Adapter implements Filterable {
    ...
    public MillPriceListAdapter(Context context, List<Mill> list, ClickListener listener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_TYPE_ITEM) {
            listHolder = new MyViewHolder(RecyclerviewMillPriceListItemBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false));
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder.getItemViewType() == VIEW_TYPE_ITEM) {
            if (holder instanceof MyViewHolder) {
                ...
                mainHolder.binding.etPrice.setText(model.getBasicPrice());
                    ...
                    mainHolder.binding.btnSubmit.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            if (price.isEmpty()) {
                                ...
                                listener.onItemSelected(list.indexOf(filterList.get(position)), price);
                            }
                        }
                    });
                ...
                if (charString.isEmpty()) {
                    ...
                    for (Mill row : list) {
                        if (row.getName().toLowerCase().contains(charString.toLowerCase()) ||
                                row.getBasicPrice().toLowerCase().contains(charString.toLowerCase())) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private RecyclerviewMillPriceListItemBinding binding;
        private ProgressbarBinding progressbarBinding;

        MyViewHolder(RecyclerviewMillPriceListItemBinding binding) {
