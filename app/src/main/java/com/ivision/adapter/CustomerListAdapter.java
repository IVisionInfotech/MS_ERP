...
public class CustomerListAdapter extends RecyclerView.Adapter implements Filterable {
    ...
    public CustomerListAdapter(Context context, List<Customer> list, ClickListener listener, ClickListener listener2) {
    ...
    public CustomerListAdapter(Context context, List<Customer> list, ClickListener listener, ClickListener listener2, ClickListener listener3) {
        this.context = context;
        this.session = new Session(context);
        this.list = list;
        this.filterList = list;
