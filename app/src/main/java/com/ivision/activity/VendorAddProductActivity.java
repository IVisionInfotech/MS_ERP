...
public class VendorAddProductActivity extends BaseActivity implements CategoryBottomSheetDialog.ItemClickListener {
    ...
    private String vendorId = "", name = "", categoryName = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        context = VendorAddProductActivity.this;
    ...
    private void init() {
        ...
        binding.cbAddStatus.setVisibility(View.GONE);
    ...
    private void addProduct() {
        ...
        apiInterface.addProduct(Constant.vendorAddProductUrl, Common.getFranchiseId(), Common.getUserId(), vendorId, name, categoryName, Common.getUsername(), Common.getPassword()).enqueue(new Callback<JsonObject>() {
